...
mySpace = Spacetime.Spacetime(xMax_tuple = (20.0,),
             numberOfNuclearDimenions = 1,
             numberOfElectronicDimensions = 2,
             numberOfSimulationSpacePointsPerNuclearDimension_tuple = (88,),
             dt_SECONDS = .500E-15,
             UnityMassInElectronMasses = 10.0)
             
             
mySpace_morse = Spacetime.Spacetime(xMax_tuple = (65.0,),
             numberOfNuclearDimenions = 1,
             numberOfElectronicDimensions = 2,
             numberOfSimulationSpacePointsPerNuclearDimension_tuple = (400,),
             dt_SECONDS = .2500E-15,
             UnityMassInElectronMasses = 10.0)
