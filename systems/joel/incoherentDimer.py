...
E_10 = omega_c - mySpace.unitHandler.energyUnitsFromWavenumbers(200.0) #joel-energy-units 
E_01 = omega_c - mySpace.unitHandler.energyUnitsFromWavenumbers(200.0) #joel-energy-units 

J = mySpace.unitHandler.energyUnitsFromWavenumbers(10.0) #joel-energy-units
...
delta_10x = mySpace.unitHandler.energyUnitsFromWavenumbers(100.0) #joel-distance-units 
delta_10y = 0

#not used here
delta_01x = 0
delta_01y = mySpace.unitHandler.energyUnitsFromWavenumbers(100.0)

pulse_width_stdev = 12.5 / (2.0 *np.sqrt(2.0 * np.log(2.0))) * 1.0E-15 #femtoseconds
print "Incoherent Dimer pulse stdev", pulse_width_stdev, "seconds"
