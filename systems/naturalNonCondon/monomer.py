...
c_natural = .1333 # was previously .20 but more accurate derivation done 7 June 2016
c_min_log = np.log10(2.06913808e-01) #-3. #
c_max_log = 1.
c_number = 9 # 20
...
mySpace = Spacetime.Spacetime(xMax_tuple = (35.0,),
             ...
             numberOfSimulationSpacePointsPerNuclearDimension_tuple = (28,),
             dt_SECONDS = .300E-15,
