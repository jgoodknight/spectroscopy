...
omega_1_e_wavenumbers = omega_1_g_wavenumbers * (1.0)
HR_1 = 0.0
mass_1_amu = 63.466

lambda_min_log = -3. #np.log10(2.06913808e-01) #
lambda_max_log = 1.
lambda_number = 20
lambda_values = np.logspace(lambda_min_log, lambda_max_log, lambda_number)
lambda_values

excited_state_offset_wavenumbers = -0.0  # this will get theoscilaltory frequencies closer to zero and allow more accuracy for a slowetime step
...
excited_state_offset = mySpace.unitHandler.energyUnitsFromWavenumbers(excited_state_offset_wavenumbers)
...
nuclear_excited_1 = NuclearOperator.harmonicOscillator(mySpace,
                                                 ...
                                                 energyOffset = excited_state_offset)
...
for l in lambda_values:
    lin_mu = NuclearOperator.functionalPositionNuclearOperator(mySpace, lambda x: mu_0 + l * x )
