...
excited_state_offset_wavenumbers = -5700.0  # this will get theoscilaltory frequencies closer to zero and allow more accuracy for a slowetime step

pulse_carrier_frequency_wavenumbers = 0.0

##all units from here on out are defined by mySpace
mySpace = Spacetime.Spacetime(xMax_tuple = (75.0,),
             numberOfNuclearDimenions = 1,
             numberOfElectronicDimensions = 2,
             numberOfSimulationSpacePointsPerNuclearDimension_tuple = (96,),
             dt_SECONDS = .100E-15,
